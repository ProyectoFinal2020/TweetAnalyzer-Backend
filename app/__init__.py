...
from .main.controllers.emotionAnalyzerController import api as emotionAnalyzer_ns
from .main.controllers.sentimentAnalyzerController import api as sentAnalyzer_ns
from .main.controllers.frequencyAnalyzerController import api as freqAnalyzer_ns
...
api.add_namespace(emotionAnalyzer_ns)
api.add_namespace(sentAnalyzer_ns)
api.add_namespace(freqAnalyzer_ns)
